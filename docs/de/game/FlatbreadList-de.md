...
- Die meisten Kartenelemente sind auf verschiedene **Biome** verteilt.
- Es gibt folgende Biome:
	- Ebenen
	- Regenwald
	- Strand
	- Ackerland
...
- Liegt am südlichsten **Ende** des Teichs, im Strand-Biom.
...
- Liegt am nördlichsten **Ende** der Karte, im Teich-Biom.
...
- Liegt im mittleren, leicht **südwestlichen** Teil der Karte, im Ebenen-Biom.
...
- Das Ackerland liegt auf der **Südostseite** des Zelts, im Ackerland-Biom.
- Wenn der Spieler diesen besonderen Bereich **betritt**, zoomt die Kamera automatisch hinein und wechselt in die Erste-Person-Perspektive, und die visuelle Oberfläche dieses besonderen Bereichs wird angezeigt.
- Das Ackerland dient zum **Pflanzen**.

### 🏪 Markt

- Der Markt liegt im **Süden** der Karte, im Dorf-Biom.
- Wenn der Spieler diesen besonderen Bereich **betritt**, zoomt die Kamera automatisch hinein und wechselt in die Erste-Person-Perspektive, und die visuelle Oberfläche dieses besonderen Bereichs wird angezeigt.
- Der Markt dient zum **Handeln**.

### 🌳 Uralter Baum

- Liegt **südöstlich** des Zelts, im Ebenen-Biom.
...
- Auf dem uralten Baum erscheinen manchmal (zum Beispiel im Herbst) **Äpfel**. Die Äpfel kann der Spieler mit einem **langen Holzstab** herunterschlagen und **einsammeln**.
- Wenn der Spieler eine Weile (etwa 1 Minute) unter dem **uralten Baum** bleibt, blendet das Spiel den schwebenden Button „Halte [W] gedrückt, um zu meditieren“ ein. Wenn der Spieler W drückt, den Button klickt oder die Controller-Taste betätigt, beginnt die **Meditation**. Während der **Meditation** zeigt das Spiel einen vollflächigen **visuellen Effekt** (verschiedene physikalische Formeln), und es besteht eine gewisse Wahrscheinlichkeit, von einem **Apfel** getroffen zu werden.
- Der uralte Baum kann **alte Blumen** (vorläufiger Name) hervorbringen. Die alten Blumen fallen von den Zweigen herab; der Spieler kann sie aufheben und **Nektar schlürfen** – mit 50 % Wahrscheinlichkeit gelingt es, **süßen Nektar** zu schlürfen.

### 🔥 Lagerfeuer

- Liegt nicht weit **östlich** des Zelts, im Ebenen-Biom.
- Wenn der Spieler diesen besonderen Bereich **betritt**, zoomt die Kamera automatisch hinein und wechselt in die Erste-Person-Perspektive, und die visuelle Oberfläche dieses besonderen Bereichs wird angezeigt.
...
- Liegt auf der **Südseite** des Zelts, im Dorf-Biom.
- Wenn der Spieler diesen besonderen Bereich **betritt**, zoomt die Kamera automatisch hinein und wechselt in die Erste-Person-Perspektive, und die visuelle Oberfläche dieses besonderen Bereichs wird angezeigt.
...
- Pilze befinden sich im **Regenwald**-Biom und werden in **giftige** und **ungiftige** Pilze unterteilt.
- Pilze vermehren sich bei **Regen** und **Gewitter**.
- Der Spieler kann einen Pilz tätscheln, um seine Vermehrung zu unterstützen; jeder Pilz kann nur einmal bei der Vermehrung unterstützt werden, getätschelt werden darf er aber beliebig oft.
- Wenn der Spieler mit einem Pilz interagiert (ihn tätschelt), gibt der Pilz einen wohltuenden **Soundeffekt** von sich; verschiedene Pilze haben unterschiedliche Tonhöhen.
- Pilze können vom Spieler **umplatziert** werden.
- Durch Anordnung und Kombination kann der Spieler aus Pilzen **Musikinstrumente** herstellen.

### ✨ Glühwürmchen

- Glühwürmchen erscheinen im Regenwald-Biom in der **Nacht**.
- Glühwürmchen leuchten von selbst und fliegen zufällig durch das Regenwald-Biom und die angrenzenden Biome.
- Der Spieler kann Glühwürmchen mit einer **Flaschenpost** einfangen und sich so selbst Licht verschaffen.
- Das Licht der Glühwürmchen-Flasche hält nur 3 Tage.
...
- Der Spieler kann Errungenschaften freischalten, indem er bestimmte **Bedingungen** erfüllt.
- Errungenschaften vergeben keine **materiellen** Belohnungen, aber es ertönt ein **Freischalt-Sound**, um den Spieler zu loben.
- Errungenschaften können versteckt sein. Versteckte Errungenschaften können vor ihrer Freischaltung nicht auf der Errungenschaftsseite eingesehen werden.
- Im **Zelt** kann der Spieler die errungenen **Errungenschaften** einsehen.

### 📍 Meilensteine

- Der Spieler kann Meilensteine auf der Meilenstein-Seite per **Klick** freischalten.
- Meilensteine haben nichts mit dem Spiel zu tun – sie sollen dafür sorgen, dass die **Erlebnisse des Spielers in der realen Welt** eine Entsprechung im Spiel finden.
- Meilensteine erfordern keinerlei **spielinterne** Bedingungen, um erreicht zu werden.
- Die Freischaltung von Meilensteinen hängt von der eigenen **Glaubwürdigkeit** des Spielers ab – nur Meilensteine, die in der realen Welt wirklich erreicht wurden, haben Bedeutung.
...
- Das Tagebuch sollte **Rich-Text** (Markdown-Syntax) unterstützen und Bilder anzeigen können.
- Die im Tagebuch angezeigten Bilder dürfen nur aus den **Zeichnungen** und **Spielscreenshots** des Spielers stammen.
...
- Die Seiten des Tagebuchs können **abgerissen** und in den **Emotions-Recycling-Behälter** geworfen werden.
...
- Die Werke des Spielers werden im **Tagebuch** **gespeichert**.
...
Ein wichtiger Weg, das Spielerlebnis zu verbessern, ist es, dem Spiel neue Inhalte hinzuzufügen – zum Beispiel durch die **Erstellung von MODs** und **Ressourcenpaketen**.

### 🔧 MOD-System

- Bereits seit der Konzeption unterstützt das Spiel den Import von **MOD-Paketen von Drittanbietern**, um die Spielinhalte zu bereichern.
- MODs sollten folgende Inhalte hinzufügen, ändern oder löschen können:
	- Biome
	- Zeitfluss
	- Gegenstände
	- Errungenschaften
	...
	- Handelstypen
	- Anbaumethoden
	- GUI-Oberflächen (einschließlich Bedienelemente)
	- Texte
	- Texturen
	- Audio
- Das Spiel sollte nahezu alle verfügbaren **Schnittstellen** samt zugehöriger Dokumentation bereitstellen und einen entsprechenden Standard entwerfen – zum Beispiel, dass bestimmte Komponenten über bestimmte Methoden aufgerufen werden müssen.
- Das Spiel **sollte** MOD-Pakete, die den Standards nicht folgen, **nicht unterstützen**.
- Der Inhalt von MOD-Paketen ist nicht eingeschränkt – auch dann nicht, wenn er gegen die Werte des Spiels verstößt.
- Das Spiel sollte eine eigene **Seite** bereitstellen, die dem Spieler hilft, MOD-Pakete zu aktivieren oder einzurichten.

### 🗂️ Ressourcenpakete

- Ressourcenpakete können die **Texte**, **Texturen** und **Audio** des Spiels verändern.
- Ressourcenpakete bieten dem Spiel keine neuen Funktionen und **dürfen** dies auch **nicht**.
- Das Spiel sollte eine eigene **Seite** bereitstellen, die dem Spieler hilft, Ressourcenpakete zu aktivieren oder einzurichten.
...
- Beim **Drücken** sollten die Bedienelemente sofort schrumpfen – mit dem **Zentrum der Oberfläche** als Skalierungszentrum – und dann nichtlinear zurückfedern.
...
- Die **Intervalldauer** und die **Überlagerungsdauer** des augenschonenden grünen Bildschirms können in den Einstellungen angepasst oder ausgeschaltet werden.
