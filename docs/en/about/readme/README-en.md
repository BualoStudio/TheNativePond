...
> [!WARNING]
> Due to force majeure, the development of Icelet has been terminated, and we are now looking for a new game engine or technical implementation to provide technical support for The Native Pond. For details, please read the Icelet termination announcement: [*“A Sudden Ending, Like Youth Itself”*](https://github.com/BualoStudio/Icelet/releases/tag/TheEnding).
